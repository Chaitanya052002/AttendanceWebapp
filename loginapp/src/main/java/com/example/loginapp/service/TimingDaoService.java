...
//	}
	...
	public List<Timings> findAllbyphoneno(int phoneno) {
		return td.findAllByUserPhoneno(phoneno);
	}

	public int findidtoupdatee(int phoneno) {
		// TODO Auto-generated method stub
		int timingtouupdateid = td.findidtoupdate(phoneno);
		return timingtouupdateid;
	}

	public void updateLastSignOutTime(int useridtoupdatetime) {
		 LocalTime time = LocalTime.now();
		 
		// TODO Auto-generated method stub
		 td.updatewithid(useridtoupdatetime,time.toString());
